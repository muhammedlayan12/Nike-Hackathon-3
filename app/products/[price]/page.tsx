...
//             <svg
//               aria-hidden="true"
//               className="w-8 h-8 text-gray-300 animate-spin dark:text-gray-600 fill-black"
//               viewBox="0 0 100 101"
//               fill="none"
...
//                   {isProducts[0]?.category}
//                 </h2>
//                 <h1 className="text-gray-900 text-3xl title-font font-medium mb-1">
//                   {isProducts[0]?.productName}
//                 </h1>
//                 <div className="flex mb-4">
//                   <span
//                     className={`${
//                       isProducts[0]?.inventory > 20
//                         ? "text-green-600"
//                         : "text-red-600"
//                     } flex gap-2 items-center ml-3`}
//                   >
//                     {isProducts[0]?.inventory}
//                     <span className="flex items-center text-black">+ Inventory</span>
//                   </span>
...
//                   <div className="flex">
//                     <span className="mr-3">
//                       Color : {isProducts[0]?.colors.join(", ")}
//                     </span>
//                   </div>
//                 </div>
//                 <div className="flex">
...
//                   </span>
//                   <button
//                     onClick={() => handleAddToCart(isProducts[0])}
//                     className="flex ml-auto text-white bg-black border-0 py-2 px-6 focus:outline-none rounded"
//                   >
//                     Add to Cart
//                   </button>
//                 </div>
